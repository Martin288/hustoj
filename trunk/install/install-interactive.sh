...
#try install tools
sudo apt-get install -y make flex g++ clang libmysql++-dev php5 php5-mysql php5-gd php5-cli mono-gmcs
...
sudo chown -R $NGINXUSER $WEBBASE/JudgeOnline
...
sudo chgrp -R $NGINXUSER /home/judge/data
